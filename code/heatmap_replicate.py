...
class Heatmap:
    ...
    def visualize(self):
        ...
        filename = f"lisa_data/cross/relation_n_max_to_m_{self.function}{self.d}d_replicate_2.csv"
        ...
        fig_name = f"lisa_data/visualization/Heatmap/{self.mode}_23_mei/heatmap_{self.function}{self.evals}_{self.d}d_replicate_no_bound_2.png"
...
if __name__ == "__main__":
    ...
    for function in n_dim_fun:
        ...
        for d in [50,100]:
            if function.__name__ == 'cigar':
                print("ah yeah")
                result = Heatmap(function.__name__, function.correction, 'median_best', 55, '', d, fsize=(10, 40))
                result.visualize()
