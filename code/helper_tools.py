...
def build_path(alg, bench, version, dims, output_dir, prefix=None):
    """
    ...
    if prefix:
        return f'../{output_dir}/{alg.__name__}_{version}/{prefix}/{bench.__name__}/{dims}d'
    return f'../{output_dir}/{alg.__name__}_{version}/{bench.__name__}/{dims}d'


def get_name(alg, bench, max_evals, version, dims, rep, output_dir, prefix=None):
    """
    ...
    """
    return f'{build_path(alg, bench, version, dims, output_dir, prefix)}/{str(rep)}_{max_evals}_2.csv'
